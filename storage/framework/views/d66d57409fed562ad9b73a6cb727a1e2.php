            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                <div class="mb-6">
                    ...
                    <a href="<?php echo e(route('admin.categories.create')); ?>" 
                       style="background-color: #2563eb; color: white; padding: 10px 20px; border-radius: 8px; text-decoration: none; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-widest">Slug</th>
...
<?php endif; ?>
<?php /**PATH D:\Praktikum_cms\resources\views/admin/categories/index.blade.php ENDPATH**/ ?>