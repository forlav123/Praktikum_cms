        ...
        <div class="nav-container">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="{{ route('shop') }}" class="{{ request()->routeIs('shop') ? 'active' : '' }}">Katalog</a></li>
        ...
        <div class="footer-container">
            ...
            <div class="footer-column">
                ...
                <ul>
                    ...
                    <li><a href="{{ route('shop') }}">Katalog</a></li>
            ...
            <div class="footer-column">
                <h3>Kategori</h3>
                <ul>
                    <li><a href="{{ route('shop') }}?category=Laptop">Laptop</a></li>
                    <li><a href="{{ route('shop') }}?category=Smartphone">Smartphone</a></li>
                    <li><a href="{{ route('shop') }}?category=Pakaian">Pakaian</a></li>
                    <li><a href="{{ route('shop') }}?category=Aksesoris">Aksesoris</a></li>
                </ul>
            </div>
            <div class="footer-column">
                <h3>Kontak Kami</h3>
                <ul style="color: var(--text-secondary); font-size: 0.9rem; gap: 0.5rem; list-style: none; padding-left: 0;">
                    ...
                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-phone" style="margin-right: 0.5rem; color: var(--accent-primary);"></i> +62 85237146917</li>
                    <li style="margin-bottom: 0.5rem;"><i class="fas fa-envelope" style="margin-right: 0.5rem; color: var(--accent-primary);"></i> forlavhadiman@gmail.com</li>
                </ul>
            </div>
        </div>
