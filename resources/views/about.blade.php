...
@section('title', 'Tentang Kami - GlowTech Store')
...
@section('content')
    ...
    <section class="about-hero">
        ...
        <p>GlowTech Store berdiri sejak tahun 2026 sebagai wadah e-commerce ritel premium yang berfokus menyajikan produk-produk teknologi orisinal berkualitas tinggi dan pakaian modern kelas atas. Kami percaya bahwa teknologi dan gaya hidup harus saling melengkapi untuk menunjang produktivitas Anda.</p>
    </section>
